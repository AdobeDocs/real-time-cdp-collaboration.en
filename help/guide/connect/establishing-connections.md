...
Connections are established based on your chosen collaboration pattern. Collaboration supports two key collaboration patterns: advertiser-to-publisher and brand-to-brand. To read more about these patterns, see the [use cases and benefits](/help/guide/use-cases-benefits.md) guide.
...
![The Send connection invite dialog with the Send invite button highlighted.](/help/assets/connect/establish-connection/send-connection-invite-dialog.png){zoomable="yes"}

>[!NOTE]
>
>If you wish to connect with a publisher you've communicated with outside of the product, you can utilize the private connection invite option. To learn more, see the [private connection invite](#private-connection-invite) section.
...
>[!IMPORTANT]
>
>Any accounts created before the **[!UICONTROL Connect code]** feature was introduced will not have a generated connect code, and the connect field will show as **[!UICONTROL Unavailable]**. Use the refresh option to generate a new connect code.
