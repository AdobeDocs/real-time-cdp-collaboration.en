...
* Set Up {#setup}
  ...
  * Source and manage audiences {#source-audiences}
    ...
    * [Configure Azure storage for audience sourcing](./setup/configure-azure-storage-audience-sourcing.md)
    * [Configure Azure permissions for audience sourcing](./setup/configure-azure-permissions-for-audience-sourcing.md)
