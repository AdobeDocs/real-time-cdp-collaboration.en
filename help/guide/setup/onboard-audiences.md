...
![An individual audience's workspace with the Edit and Delete option highlighted.](/help/assets/setup/add-manage-audiences/audience-details-edit-delete.png){zoomable="yes"}
