...
* Select an advertiser name if the advertiser configured multiple advertiser names in the connection settings. Otherwise, the name of the advertiser is preselected ad adertiser name. Or, if the advertiser configured a single advertiser name in the connection settings, that name is prefilled in this selection. [Read more](/help/guide/connect/establishing-connections.md#connection-settings) about advertiser names.
