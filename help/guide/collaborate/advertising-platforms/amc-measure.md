...
solution: Real-Time CDP Collaboration
...
>[!NOTE]
>
>If you did not select [!UICONTROL Attribution] in the [Report type](#report-type) section, skip this section and select **[!UICONTROL Create]** to submit the form.
