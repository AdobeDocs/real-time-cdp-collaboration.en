...
| Placement-level conversion reporting | Attribution reports now support placement-level conversion reporting, showing conversion count and conversion value by Placement ID within each Campaign ID. This provides separate results for campaigns containing multiple placements. The former Revenue metric label has been updated to Conversion Value for clarity. For more information, see [conversions by placement](../collaborate/measure.md#conversions-by-placement). |
